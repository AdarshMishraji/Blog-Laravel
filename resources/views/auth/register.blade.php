...
@section('content')
    <main class="sm:container sm:mx-auto sm:max-w-lg h-full">
        <div class="flex">
            <div class="w-full my-40">
                <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-3xl sm:shadow-lg">
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                        ...
                        <div class="flex flex-wrap">
                            <button type="submit"
                                class="w-full select-none font-bold whitespace-no-wrap p-3 rounded-3xl text-base leading-normal no-underline text-gray-100 bg-blue-500 hover:bg-blue-700 sm:py-4">
                                {{ __('Register') }}
                            </button>
